  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="h-7 min-w-7 shrink-0 flex items-center justify-center rounded-md hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
        >
...
const FontFamilyButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="h-7 w-[120px] shrink-0 flex items-center justify-between rounded-md hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
        >
          <span className="truncate" >
